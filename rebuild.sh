...
pdfjam pod/pdf/cards/products/accessories/*.pdf pod/pdf/cards/products/sub_era_1/*.pdf pod/pdf/cards/products/sub_era_2/*.pdf pod/pdf/cards/products/sub_era_3/*.pdf pod/pdf/cards/products/sub_era_4/*.pdf pod/pdf/cards/products/sub_era_5/*.pdf pod/pdf/cards/events/*.pdf pod/pdf/cards/personalities/*.pdf --no-landscape --frame true --nup 5x4 --suffix complete --outfile ./comp_print_cards.pdf

mv ./comp_print_cards.pdf pod/comp_print_cards.pdf
