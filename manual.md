...
**Research & Development** R&D Resources are generally saved to be used to allocate to a product card drawn from the product area of the main board. Once the product has been built, the resources are discarded. Spare R&D resources can also be used to draw additional cards from the products track in the action phase.
